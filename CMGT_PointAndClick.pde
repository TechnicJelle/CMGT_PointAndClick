...
void setup()
{
  ...
  MoveToSceneObject kitchenTaskArrow = new MoveToSceneObject("goToKitchenTask", gwidth/2, gheight/2, "arrowUp.png", "kitchenTask");

  kitchen.addGameObject(readingLRBackArrow);
  kitchen.addGameObject(kitchenTaskArrow);
  ...
  Scene kitchenTask = new Scene("kitchenTask", "TaskConcept1.png");
  
  Collectable sponge = new Collectable("sponge", "sponge.png");
  CollectableObject spongeItem = new CollectableObject("spongeOnTheSink", 1000, 500, sponge);
  
  Collectable dishes = new Collectable("dishes", "dish.png");
  
  
  //Collectable dirtyDish = new Collectable("dirtyDish", "dirtyDish.png");

  

  MoveToSceneObject kitchenBackArrow = new MoveToSceneObject("goBackToKitchen", gwidth/2, gheight-100, "arrowDown.png", true);

  kitchenTask.addGameObject(kitchenBackArrow);
  kitchenTask.addGameObject(spongeItem);
  ...
  sceneManager.addScene(kitchenTask);
